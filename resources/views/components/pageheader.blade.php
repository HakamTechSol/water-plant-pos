<div class="page-header">
    ...
    <div class="page-btn">
        <a href="{{route('addbrand')}}" class="btn btn-added"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" class="me-2" alt="img">Add Brand</a>
    </div>
    @endif
    ...
    @endif
    @if(Route::is(['user-account-list']))
    <div class="page-btn">
        <a href="{{url('add-user-account')}}" class="btn btn-added"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img">Add User</a>
    </div>
    @endif
    ...
    @endif
    @if(Route::is(['sizelist']))
    <div class="page-btn">
        <a href="{{url('size')}}" class="btn btn-added"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" class="me-2" alt="img"> Add Size</a>
    </div>
    @endif
    ...
    <div class="page-btn">
        <a class="btn btn-added" href="{{ route('add.purchase') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Order</a>
    </div>
    @endif
    @if(Route::is(['invoice.list']))
    <div class="page-btn">
        <a class="btn btn-added" href="{{ route('add.invoice') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Invoice</a>
    </div>
    @endif
    @if(Route::is(['list.expense']))
    <div class="page-btn">
        <a class="btn btn-added" href="{{ route('create.expense') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Expense</a>
    </div>
    @endif
    @if(Route::is(['account.list']))
    <div class="page-btn">
        <a class="btn btn-added" href="{{ Route('preview.account.page') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Account</a>
    </div>
    @endif
    @if(Route::is(['quotation.list']))
    <div class="page-btn">
        <a class="btn btn-added" href="{{ Route('add.quote') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Quote</a>
    </div>
    @endif
    @if(Route::is(['plant.list']))
    <div class="page-btn">
        <a class="btn btn-added" href="{{ Route('add.plant') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Plant</a>
    </div>
    @endif
    @if(Route::is(['Specificationlist']))
    <div class="page-btn">
        <a class="btn btn-added" href="{{ Route('add_specification') }}"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add Specification</a>
    </div>
    @endif
    ...
    <div class="page-btn">
        <a href="{{url('adduser')}}" class="btn btn-added"><img src="{{ URL::asset('/assets/img/icons/plus.svg')}}" alt="img" class="me-2">Add Employee</a>
    </div>
    @endif
