                                ...
                                <form action="{{route('addcustomeronsales')}}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label>Phone</label>
                                                <input required type="text" name="customer_phone" maxlength="11">
                                                <div class="text-danger">
                                                    @error('0')
                                                    {{$customer_phone}}
                                                    @enderror
                ...
                <form method="POST" action="{{route('addsales')}}">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-9 col-sm-9 col-9">
                                        ...
                                        <select required class="select" name="customer">
                                    ...
                                    <div class="col-lg-3 col-sm-3 col-3 ps-0">
                                        <button style="margin-top:-8px" class="btn" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                            <div class="add-icon">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-groupicon">
                                    <input required type="text" placeholder="Choose Date" name="orderdate" class="datetimepicker">
                                    <a class="addonset">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                <label>Status</label>
                                <!-- <select required class="select" name="status">
                        ...
                        <div class="col-lg-3 col-sm-9 col-9 mb-4">
                            <div class="form-group">
                                ...
                                <select required class="select" title="Please Select Account" name="sale_account">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6 ">
                                <div class="total-order w-100 max-widthauto m-auto mb-4">
                                    <ul>
                                        ...
                                        <li class="total">
                                            <h4>Total</h4>
                                            <input required type="number" class="form-control" readonly name="totalamount" id="totalamount">
                            ...
                            <div class="col-lg-3 col-sm-9 col-9 mb-4">
                                <div class="form-group">
                                    <label>Tax (%)</label>
                                    <input required onkeyup="grandtotalcalculator()" id="taxval" type="number" name="tax" value="0" class="form-control">
                                    <span></span>
                                </div>
                                <div class="text-danger">
                                    @error('0')
                            ...
                            <div class="col-lg-3 col-sm-9 col-9 mb-4">
                                ...
                                <div class="form-group">
                                    <label>Save As</label>
                                    <select required class="select" title="Please Select Type" name="sale_type">
                                        <option>Please Select Option</option>
                                        <option selected value="Official">Pure Water</option>
                                        <option value="Unofficial">Water Care House</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6 ">
                                <div class="total-order w-100 max-widthauto m-auto mb-4">
                                    <ul>
                                        <li class="total">
                                            <h4>Grand Total</h4>
                                            <input required type="number" class="form-control" readonly id="grandtotal">
                                            <!-- // <h5 id="totalamount">RS: 0.00</h5> -->
                                            <!-- <input required type="hidden"  /> -->
                                        </li>
                                    </ul>
